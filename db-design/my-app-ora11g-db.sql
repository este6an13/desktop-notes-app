...
alter table EXAMPLE
   drop constraint FK_ENTRY_IN_EXAMPLE;
...
(
   ...
   TEXT_ENTRY           VARCHAR2(10000)      not null,
   TYPE_ENTRY           CHAR(1)              not null
      constraint CKC_TYPE_ENTRY_ENTRY check (TYPE_ENTRY in ('C','I')),
...
(
   ...
   ID_ENTRY             INTEGER              not null,
   TITLE_EXAMPLE        VARCHAR2(100),
   TEXT_EXAMPLE         VARCHAR2(5000),
   constraint PK_EXAMPLE primary key (ID_EXAMPLE)
);

/*==============================================================*/
/* Index: ENTRY_EXAMPLE_FK                                      */
/*==============================================================*/
create index ENTRY_EXAMPLE_FK on EXAMPLE (
   ID_ENTRY ASC
);
...
alter table EXAMPLE
   add constraint FK_ENTRY_IN_EXAMPLE foreign key (ID_ENTRY)
      references ENTRY (ID_ENTRY);

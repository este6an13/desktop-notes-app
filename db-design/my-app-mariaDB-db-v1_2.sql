...
/* It was necessary to eecute this command first: ALTER TABLE ENTRY DROP CONSTRAINT ENTRY_CHK_TABLE

ALTER TABLE ENTRY ADD CONSTRAINT ENTRY_CHK_TABLE CHECK((TYPE_ENTRY = 'C' && TITLE_ENTRY IS NOT NULL) || (TYPE_ENTRY = 'I' && TEXT_ENTRY IS NOT NULL) || (TYPE_ENTRY = 'E' && TITLE_ENTRY IS NULL && TEXT_ENTRY IS NOT NULL) || (TYPE_ENTRY = 'E' && TITLE_ENTRY IS NULL && TEXT_ENTRY IS NULL));

/* my constraint didn't work properly. Needed to set TEXT_ENTRY to null (optional) from phpMyAdmin GUI. Then we can use a simpler way of the alter table add constraint

Here the correction:

ALTER TABLE ENTRY DROP CONSTRAINT ENTRY_CHK_TABLE

ALTER TABLE ENTRY ADD CONSTRAINT ENTRY_CHK_TABLE CHECK((TYPE_ENTRY = 'C' && TITLE_ENTRY IS NOT NULL) || (TYPE_ENTRY = 'I' && TEXT_ENTRY IS NOT NULL) || (TYPE_ENTRY = 'E'));